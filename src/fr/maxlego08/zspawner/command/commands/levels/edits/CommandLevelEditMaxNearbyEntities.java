...
public class CommandLevelEditMaxNearbyEntities extends VCommand {

	public CommandLevelEditMaxNearbyEntities() {
		this.setPermission(Permission.ZSPAWNER_LEVEL_EDIT);
		this.setDescription(Message.DESCRIPTION_LEVEL_EDIT_MAX_ENTITIES);
		this.addSubCommand("maxnearbyentities");
	...
	protected CommandType perform(ZSpawnerPlugin main) {
		...
		manager.getLevelManager().updateLevel(sender, Value.ENTITIES, level, value);
