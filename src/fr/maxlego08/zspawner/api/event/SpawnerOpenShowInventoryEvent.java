...
public class SpawnerOpenShowInventoryEvent extends SpawnerEvent {

	private final Inventory inventory;
	private final PlayerSpawner playerSpawner;
	private final Player player;
	public SpawnerOpenShowInventoryEvent(Inventory inventory, PlayerSpawner playerSpawner, Player player) {
		super();
